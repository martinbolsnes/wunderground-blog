...
function ArticleSection4col() {
  return (
    <section className='max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 mt-20'>
      <h3 className='font-serif text-gray text-lg -mt-10 mb-6'>Latest</h3>
